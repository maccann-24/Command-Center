...
def test_simulated_scheduling():
    ...
    print(f"Note: Using test intervals (Job1: {TEST_JOB1_INTERVAL}s, Job2: {TEST_JOB2_INTERVAL}s)\n")
...
def test_job_functions():
    ...
    patterns = [
        ('from ingestion.polymarket import fetch_markets', 'Imports fetch_markets from polymarket.py'),
