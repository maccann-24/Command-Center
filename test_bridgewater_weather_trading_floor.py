#!/usr/bin/env python3
"""
Live integration test for Bridgewater Weather Agent + Trading Floor
...
def test_bridgewater_weather_trading_floor():
    """Test Bridgewater Weather Agent with Trading Floor integration."""
    
    print("\n" + "="*60)
    print("🧪 BRIDGEWATER WEATHER AGENT - TRADING FLOOR TEST")
    print("="*60 + "\n")
    ...
    try:
        ...
        print(f"   Max Risk Score: {agent.max_risk_score}/10")
...
if __name__ == "__main__":
    sys.exit(test_bridgewater_weather_trading_floor())
