#!/usr/bin/env python3
"""
Live integration test for Renaissance Weather Agent + Trading Floor
...
def test_renaissance_weather_trading_floor():
    """Test Renaissance Weather Agent with Trading Floor integration."""
    
    print("\n" + "="*60)
    print("🧪 RENAISSANCE WEATHER AGENT - TRADING FLOOR TEST")
    print("="*60 + "\n")
...
if __name__ == "__main__":
    sys.exit(test_renaissance_weather_trading_floor())
