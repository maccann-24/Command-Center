"""Live integration test: RenaissancePoliticsAgent → Trading Floor messages.
...
Run:
  python3 test_renaissance_politics_trading_floor.py
"""
...
def main() -> None:
    ...
    try:
        ...
        print("\n=== TEST RESULT: renaissance_politics ===")
